...
class VoyagerBreadBetsController extends VoyagerController
{
    ...
    public function index(Request $request)
    {
        ...
        $betDataCount = Bet::where('id','!=',0 )->count();
        $betData['total_bets'] = $betDataCount;

        $betDataPending = Bet::where('state','pending' )->count();
        $betData['total_pending'] = $betDataPending;

        $betDataPlayed = Bet::where('state','finished' )->count();
        $betData['total_played'] = $betDataPlayed;

        $betDataPlaying = Bet::where('state','ongoing' )->count();
        $betData['total_playing'] = $betDataPlaying;

        $betDataCancelled = Bet::where('state','cancelled' )->count();
        $betData['total_cancelled'] = $betDataCancelled;
