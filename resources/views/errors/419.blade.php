...
<head>
    ...
    <title>APP Plus: Free Responsive HTML 5 Template</title>
    ...
    <link rel="apple-touch-icon" href='{{ asset("imagesx/touch/apple-touch-icon.png") }}'>
    <link rel="apple-touch-icon" sizes="72x72" href='{{ asset("imagesx/touch/apple-touch-icon-72x72.png") }}'>
    <link rel="apple-touch-icon" sizes="114x114" href='{{ asset("imagesx/touch/apple-touch-icon-114x114.png") }}'>
    <link rel="apple-touch-icon" sizes="144x144" href='{{ asset("imagesx/touch/apple-touch-icon-144x144.png") }}'>
    ...
    <link rel="stylesheet" href='{{ asset("cssx/style.css") }}'>
    <link rel="stylesheet" href="https://maxcdn.bootstrapcdn.com/font-awesome/4.4.0/css/font-awesome.min.css">
    <!--[if lt IE 9]>
        <script src='{{ asset("jsx/html5.js") }}'></script>
        <script src='{{ asset("jsx/respond.js") }}'></script>
    <![endif]-->
</head>
<body class="no-js">
    <div class="main">
        <header>
            <div class="wrap">
                <img src='{{ asset("uploadx/iPhone.png") }}' height="532" width="252" alt="" class="header-img">
                <div class="header-wrapper">
                    ...
                    <p class="autor"><a href="#">John Doe</a></p>
        ...
        <div class="spanning">
            ...
            <div class="discover clearfix">
                <div class="wrap">
                    ...
                    <div class="screen-couple-left wow fadeInLeftBig">
                        ...
                        <img class="screen above" src='{{ asset("imagesx/screen_couple_above_v2.png") }}' alt="" height="484" width="250"/> <img class="screen beyond wow fadeInLeft" data-wow-delay="0.5s" src='{{ asset("imagesx/screen_couple_beyond_v2.png") }}' alt="" height="407" width="210" /> 
                    </div>
                </div>
                <!-- /.wrap -->
            </div>
            ...
            <div class="video clearfix">
                <div class="wrap">
                    <div class="video-title">Explore. APP Plus in action</div>
                    <div class="video-subtitle">Just try it for yourself</div>
                    <div class="video-block">
                       <iframe src="https://player.vimeo.com/video/80370706" width="814" height="458" frameborder="0" webkitallowfullscreen mozallowfullscreen allowfullscreen></iframe>
                    </div>
            ...
            <div class="comments clearfix">
                <div class="wrap">
                    <div class="tab">
                        ...
                        <div class="box">
                            <h4>Folks enjoying <a href="#">#APP-PLUS</a></h4>
                            <p>Nothing to fear, the new #APP-PLUS has my tiny street covered, so cool and such a powerful app.</p>
                        </div>
                        <ul class="tabs">
                            <li class="active"></li>
                            <li></li>
            ...
            <div class="simple clearfix">
                <div class="wrap">
                    <div class="simple-content">
                        ...
                        <ul>
                            <li class="clearfix"><img src='{{ asset("uploadx/ico1.png") }}' height="32" width="32" alt=""><span>Fastest navigation</span></li>
                            <li class="clearfix"><img src='{{ asset("uploadx/ico2.png") }}' height="32" width="32" alt=""><span>Huge number of cities</span></li>
                            <li class="clearfix"><img src='{{ asset("uploadx/ico3.png") }}' height="32" width="32" alt=""><span>Only the best routes</span></li>
                            <li class="clearfix"><img src='{{ asset("uploadx/ico4.png") }}' height="32" width="32" alt=""><span>Beautiful locations</span></li>
                            <li class="clearfix"><img src='{{ asset("uploadx/ico5.png") }}' height="32" width="32" alt=""><span>Cloud sync</span></li>
                        </ul>
                    </div>
                    <div class="simple-img">
                        <img src='{{ asset("uploadx/screen.png") }}' height="508" width="587" alt="">
                    </div>
                </div>
                <!-- /.wrap -->
            </div>
    ...
    <section id="download" class="bg-color-main">
        <div class="container-fluid"> <a href="#wrap" class="goto">
            <h2><div class="download"><i class="fa fa-apple"></i> Download App</div></h2>
            </a> </div>
    ...
    <footer>
        <div class="wrap">
            <p>&copy; 2014 <strong>APP Plus</strong>, All Rights Reserved</p>
            <p class="text-center"> Theme by <a href="https://themewagon.com/"> Themewagon </a> </p>
        </div>
        <!-- /.wrap -->
    </footer>
    <script src='{{ asset("jsx/jquery.js") }}'></script>
    <script src='{{ asset("jsx/library.js") }}'></script>
    <script src='{{ asset("jsx/script.js") }}'></script>
    <script src='{{ asset("jsx/retina.js") }}'></script>
</body>
</html>